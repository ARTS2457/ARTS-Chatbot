...
function getAnswer(question) {
    ...
    const Hpac = ["what is the highest package","highest package","higher package","maximum package","highest salary","highest annual salary"];
    
    const Apac = ["what is the average package","average package","avg package","minimum package","lowest salary","avg annual salary","average annual salary"];
    ...
    const message = question.toLowerCase();
        ...
        else if (checkKeywords(message, Hpac)) {
            return getHpac();
        }
        else if (checkKeywords(message, Apac)) {
            return getApac();
        }
...
function getHpac(){
    return "Highest package is ₹ 7 lakh."
}
function getApac(){
    return "Average package is ₹ 3 lakh."
}
function getvision(){
